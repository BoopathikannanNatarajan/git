...
<html lang="en">
  <head>
    ...
    <title>Homepage 8 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
            ...
            <div class="col-lg-6 text-center mb-30">
              <div class="box-phones">
                <div class="box-phones-inner">
                  <div class="img-phone-1 wow animate__animated animate__zoomIn" data-wow-delay=".0s"><img src="assets/imgs/page/homepage8/phone1.png" alt="iori"></div>
                  <div class="img-phone-2 wow animate__animated animate__zoomIn" data-wow-delay=".4s"><img src="assets/imgs/page/homepage8/phone2.png" alt="iori"></div>
                </div>
              </div>
            </div>
            <div class="col-lg-6 mb-30">
              <div class="box-our-app"><span class="title-line line-48 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">Why using our app</span>
                <h3 class="color-brand-1 mb-20 mt-15 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">Our app is great for individuals, startups and enterprises. It have never been easier to manage your finances</h3>
                <p class="font-sm color-grey-500 mb-40 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">Eos eveniet nesciunt et accusamus suscipit est magnam consequatur aut quisquam perferendis a reprehenderit quis aut voluptatem repellat est beatae reiciendis? Cum omnis corrupti cum incidunt veritatis vel libero provident aut reiciendis animi ut quod quaerat et velit animi et omnis illo. Sit quae harum eos incidunt sequi eum iste fugit ex omnis aliquam a explicabo quam.</p>
                <div class="box-item-comment wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                  <div class="image-comment"><img src="assets/imgs/page/homepage8/author.png" alt="iori"></div>
                  <div class="info-comment">
                    <p class="font-lg-bold color-grey-500 comment-quote mb-15">Et corporis quia est iusto delectus ea consequuntur sapiente in quia totam ut internos architecto. Eos deleniti dolore eos enim totam et eaque nisi.</p><span class="font-md-bold color-brand-1">Albert Flores</span>
        ...
        <div class="container">
          <div class="box-radius-logo">
            <div class="text-center">
              <p class="font-lg color-brand-1 wow animate__animated animate__fadeInUp">Loved By Developers, Trusted By Enterprises</p>
            </div>
            <div class="mt-30">
                  ...
                  <div class="item-chart-inner">
                    <div class="row">
                        ...
                        <div class="card-comment">
                          ...
                          <div class="card-info">
                            <div class="card-title"><span class="font-md-bold color-brand-1 title-comment">Bessie Cooper</span>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"></div>
                            </div>
                      ...
                      <div class="col-lg-6 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                        <div class="card-comment">
                          <div class="card-image"><img src="assets/imgs/page/homepage8/author2.png" alt="iori"></div>
                          <div class="card-info">
      ...
      <section class="section mt-90">
        <div class="container">
          ...
          <div class="row mt-75 align-items-center">
            <div class="col-lg-4 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".s">
              <div class="card-become">
                <div class="card-title text-end">
                  <h6 class="color-brand-1 mb-15"><span>Total control</span><img class="ml-15" src="assets/imgs/page/homepage8/icon1.png" alt="iori"></h6>
                </div>
                <div class="card-desc">
              ...
              <div class="card-become">
                <div class="card-title text-end">
                  <h6 class="color-brand-1 mb-15"><span>Rapid experimentation</span><img class="ml-15" src="assets/imgs/page/homepage8/icon2.png" alt="iori"></h6>
                </div>
                <div class="card-desc">
                  <p class="text-end color-grey-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus malesuada felis eget finibus placerat. Aliquam sit amet vestibulum felis, sit amet porta neque</p>
                </div>
              ...
              <div class="card-become">
                <div class="card-title text-end">
                  <h6 class="color-brand-1 mb-15"><span>Secure transfer</span><img class="ml-15" src="assets/imgs/page/homepage8/icon3.png" alt="iori"></h6>
                </div>
                <div class="card-desc">
                  <p class="text-end color-grey-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus malesuada felis eget finibus placerat. Aliquam sit amet vestibulum felis, sit amet porta neque</p>
                </div>
              ...
              <div class="card-become">
                <div class="card-title text-end">
                  <h6 class="color-brand-1 mb-15"><span>Activity statistics</span><img class="ml-15" src="assets/imgs/page/homepage8/icon4.png" alt="iori"></h6>
                </div>
                <div class="card-desc">
                  <p class="text-end color-grey-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus malesuada felis eget finibus placerat. Aliquam sit amet vestibulum felis, sit amet porta neque</p>
                </div>
            ...
            <div class="col-lg-4 mb-30 text-center wow animate__animated animate__fadeIn" data-wow-delay=".s"><img src="assets/imgs/page/homepage8/phone2.png" alt="iori"></div>
            <div class="col-lg-4 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".s">
              <div class="card-become">
                <div class="card-title text-start">
                  <h6 class="color-brand-1 mb-15"><img class="mr-15" src="assets/imgs/page/homepage8/icon5.png" alt="iori"><span>Track your spending</span></h6>
                </div>
                <div class="card-desc">
              ...
              <div class="card-become">
                <div class="card-title text-start">
                  <h6 class="color-brand-1 mb-15"><img class="mr-15" src="assets/imgs/page/homepage8/icon6.png" alt="iori"><span>Fast Response</span></h6>
                </div>
                <div class="card-desc">
                  <p class="text-start color-grey-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus malesuada felis eget finibus placerat. Aliquam sit amet vestibulum felis, sit amet porta neque</p>
                </div>
              ...
              <div class="card-become">
                <div class="card-title text-start">
                  <h6 class="color-brand-1 mb-15"><img class="mr-15" src="assets/imgs/page/homepage8/icon7.png" alt="iori"><span>AI automation</span></h6>
                </div>
                <div class="card-desc">
                  <p class="text-start color-grey-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus malesuada felis eget finibus placerat. Aliquam sit amet vestibulum felis, sit amet porta neque</p>
                </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 text-center">
              <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".0s"> Why You Should Consider Installing</h2>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 text-center mb-70">
              <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".s"> What our custommers are saying</h2>
          ...
          <div class="row align-items-start" data-masonry="{&quot;percentPosition&quot;: true }">
            <div class="col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".s">
            ...
            <div class="col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
              <div class="card-testimonial-grid">
            ...
            <div class="col-lg-4 col-md-6 mb-30 testimonial-warning wow animate__animated animate__fadeIn" data-wow-delay=".5s">
              <div class="card-testimonial-grid">
            ...
            <div class="col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".6s">
              <div class="card-testimonial-grid">
