...
<html lang="en">
  <head>
    ...
    <title>Homepage 5 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
    ...
    <header class="header sticky-bar header-home5">
      <div class="container">
        <div class="main-header">
          <div class="header-left">
            <div class="header-logo"><a class="d-flex" href="index.html"><img alt="Ecom" src="assets/imgs/template/"></a></div>
        ...
        <div class="container">
          <div class="mt-65 mb-100">
            <div class="row align-items-end">
              <div class="col-lg-6 mb-20"><span class="title-line color-brand-2 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">Great sales platform</span>
                <h2 class="color-brand-2 mt-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">#1 Intelligence Software to Accelerate Your SaaS Sales</h2>
              </div>
            ...
            <div class="box-video-banner">
              <div class="image-banner-5 wow animate__animated animate__fadeIn"><img src="assets/imgs/page/homepage5/banner.png" alt="IORI"><a class="btn btn-play-center popup-youtube" href="https://www.youtube.com/watch?v=sVPYIRF9RCQ"></a></div>
            </div>
          ...
          <div class="box-radius-16 bg-4">
            <div class="row">
              <div class="col-lg-12 text-center">
                <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".0s">Take your social media marketing<br class="d-none d-lg-block">prowess to the next level</h2>
              </div>
            </div>
            <div class="row mt-50">
              <div class="col-lg-6 col-md-12 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                <div class="card-offer card-we-do card-marketing hover-up">
                  <div class="card-image"><span class="cover-image"><img src="assets/imgs/page/homepage1/cross2.png" alt="iori"></span></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-10"><a class="color-brand-1" href="job-detail.html">Cross-Platform</a></h4>
                    <p class="font-md color-grey-500 mb-5">Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p>
              ...
              <div class="col-lg-6 col-md-12 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                <div class="card-offer card-we-do card-marketing hover-up">
                  <div class="card-image"><span class="cover-image"><img src="assets/imgs/page/homepage1/cross.png" alt="iori"></span></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-10"><a class="color-brand-1" href="job-detail.html">Social Media</a></h4>
                    <p class="font-md color-grey-500 mb-5">Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p>
                    <div class="box-button-offer"><a class="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                        <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
              ...
              <div class="col-lg-6 col-md-12 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                <div class="card-offer card-we-do card-marketing hover-up">
                  <div class="card-image"><span class="cover-image"><img src="assets/imgs/page/homepage1/cross4.png" alt="iori"></span></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-10"><a class="color-brand-1" href="job-detail.html">Brand Identity</a></h4>
                    <p class="font-md color-grey-500 mb-5">Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p>
                    <div class="box-button-offer"><a class="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                        <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
              ...
              <div class="col-lg-6 col-md-12 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                <div class="card-offer card-we-do card-marketing hover-up">
                  <div class="card-image"><span class="cover-image"><img src="assets/imgs/page/homepage1/cross5.png" alt="iori"></span></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-10"><a class="color-brand-1" href="job-detail.html">Customer Service</a></h4>
                    <p class="font-md color-grey-500 mb-5">Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p>
                    <div class="box-button-offer"><a class="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                        <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
        ...
        <div class="container">
          <div class="box-container">
              ...
              <div class="col-xl-6 col-lg-6 mb-30">
                <div class="box-images-cover">
                  <div class="box-images-inner">
                    <div class="img-reveal"><img class="img-project bd-rd16" src="assets/imgs/page/homepage5/img-project.png" alt="iori"></div>
                    <div class="image-6 shape-3"><img src="assets/imgs/page/homepage5/chart.png" alt="iori"></div>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 col-lg-6 mb-30"><span class="btn btn-tag wow animate__animated animate__fadeIn" data-wow-delay=".0s">Business</span>
                <h3 class="color-brand-1 mt-10 mb-15 wow animate__animated animate__fadeIn" data-wow-delay=".1s">Integrate with over 1,000 project management apps</h3>
            ...
            <div class="row mb-0 mt-40 project-revert align-items-center">
              <div class="col-xl-5 col-lg-6 col-md-6 mt-30"><span class="btn btn-tag">Business</span>
                ...
                <div class="mt-50 text-start"><a class="btn btn-brand-1 hover-up" href="#">Download App</a><a class="btn btn-default font-sm-bold hover-up" href="#">Learn More
                    <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                    </svg></a></div>
              </div>
              <div class="col-xl-7 col-lg-6 col-md-6 mt-30">
                <div class="box-images-cover text-end">
                  <div class="box-images-inner">
                    <div class="img-reveal"><img class="img-project bd-rd16" src="assets/imgs/page/homepage5/img-project2.png" alt="iori"></div>
                    <div class="image-7 shape-3"><img src="assets/imgs/page/homepage1/finger.png" alt="iori"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="box-radius-16 pl-0 pr-0 pb-0 overflow-hidden bg-7">
            <div class="box-container">
              <div class="row">
                <div class="col-lg-6">
                  <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".0s">Business can also be simple</h2>
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-sm-6 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                      <div class="box-image-bg-60">
                        <div class="img-reveal"><img class="d-block" src="assets/imgs/page/homepage3/personal.svg" alt="iori"></div>
                      </div>
                    ...
                    <div class="col-lg-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                      <div class="box-image-bg-60">
                        <div class="img-reveal"><img class="d-block" src="assets/imgs/page/homepage3/building.svg" alt="iori"></div>
                      </div>
            ...
            <div class="row align-items-center mt-60">
              <div class="col-lg-6">
                <div class="img-reveal"><img class="d-block w-100" src="assets/imgs/page/homepage5/img.png" alt="iori"></div>
              </div>
              <div class="col-lg-6">
