...
<html lang="en">
  <head>
    ...
    <title>404 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
          ...
          <div class="row">
            ...
            <div class="col-lg-10">
              <div class="row align-items-center">
                <div class="col-md-5 col-sm-12 mb-30 text-center text-md-start"><img src="assets/imgs/page/404/404.png" alt="iori"></div>
                <div class="col-md-7 col-sm-12 text-center text-md-start">
                  ...
                  <div class="mt-50 wow animate__animated animate__fadeIn" data-wow-delay=".3s"><a class="btn btn-default color-grey-900 pl-0" href="index.html">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-small card-small-2">
                ...
                <div class="card-info">
                  ...
                  <p class="font-xs color-grey-500">Email<a class="color-success" href="/cdn-cgi/l/email-protection#5c2f292c2c332e281c3d303528343931392f723f3331"><span class="__cf_email__" data-cfemail="d1a2a4a1a1bea3a591b0bdb8a5b9b4bcb4a2ffb2bebc">[email&#160;protected]</span></a><br>For help with a current product or service or refer to FAQs and developer tools</p>
                </div>
              </div>
            </div>
