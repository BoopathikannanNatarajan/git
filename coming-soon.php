...
<html lang="en">
  <head>
    ...
    <title>Comming soon - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
      ...
      <div class="mobile-header-wrapper-inner">
        <div class="mobile-header-content-area">
          ...
          <div class="perfect-scroll">
            ...
            <div class="site-copyright color-grey-400 mt-30">Copyright 2025 &copy; IORI - Marketplace Template.<br>Designed by<a href="http://alithemes.com" target="_blank">&nbsp; AliThemes</a></div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 mb-40"><span class="btn btn-tag wow animate__animated animate__fadeIn" data-wow-delay=".0s">Under Construction</span>
              <h1 class="color-brand-1 mt-15 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">We are coming soon</h1>
              <div class="box-count box-count-square mb-50">
                <div class="deals-countdown" data-countdown="2025/02/25 00:00:00"></div>
              </div>
              <p class="font-md color-grey-500 wow animate__animated animate__fadeIn" data-wow-delay=".0s">Our design projects are fresh and simple and will benefit your<br class="d-none d-lg-block">business greatly. Learn more about our work!</p>
              <div class="row">
                <div class="col-lg-9">
                  <div class="box-notify-me mt-15">
                    <div class="inner-notify-me wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                      ...
                      <button class="btn btn-brand-1 font-md">Notify Me
              ...
              <div class="mt-45 wow animate__animated animate__fadeIn" data-wow-delay=".0s"><a class="icon-socials icon-facebook mr-15" href="#"></a><a class="icon-socials icon-instagram mr-15" href="#"></a><a class="icon-socials icon-twitter mr-15" href="#"></a><a class="icon-socials icon-linkedin mr-15" href="#"></a><a class="icon-socials icon-youtube" href="#"></a></div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-small card-small-2">
                ...
                <div class="card-info">
                  ...
                  <p class="font-xs color-grey-500">Email<a class="color-success" href="/cdn-cgi/l/email-protection#e2919792928d9096a2838e8b968a878f8791cc818d8f"><span class="__cf_email__" data-cfemail="80f3f5f0f0eff2f4c0e1ece9f4e8e5ede5f3aee3efed">[email&#160;protected]</span></a><br>For help with a current product or service or refer to FAQs and developer tools</p>
                </div>
              </div>
            </div>
