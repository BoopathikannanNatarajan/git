...
<html lang="en">
  <head>
    ...
    <title>About - Multipurpose Startup & SaaS Template</title>
        ...
        <div class="container text-center">
          ...
          <div class="box-radius-border mt-50">
            <div class="box-list-numbers">
              ...
              <div class="item-list-number">
                <div class="box-image-bg"><img src="assets/imgs/page/homepage3/research.png" alt="iori"></div>
                <h2 class="color-brand-1"><span class="count">100</span><span>+</span></h2>
                <p class="color-brand-1 font-lg">Global branch</p>
              </div>
              <div class="item-list-number">
                <div class="box-image-bg"><img src="assets/imgs/page/homepage3/conference.png" alt="iori"></div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="item-core mb-30">
                <div class="item-image"><img src="assets/imgs/page/about/img1.png" alt="iori"></div>
                <div class="item-desc">
            ...
            <div class="col-lg-6">
              <div class="item-core mb-30">
                <div class="item-image"><img src="assets/imgs/page/about/img2.png" alt="iori"></div>
                <div class="item-desc">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
              <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="box-info-video">
                  <div class="img-reveal"><img class="bd-rd8 d-block" src="assets/imgs/page/about/img3.png" alt="iori"></div>
                </div>
              </div>
              <div class="col-xl-6 col-lg-6 col-md-6">
          ...
          <div class="box-story box-story-2">
            <div class="row align-items-center">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="box-info-video">
                  <div class="img-reveal"><img class="bd-rd8 d-block" src="assets/imgs/page/about/img4.png" alt="iori"></div>
                </div>
              </div>
            </div>
          </div>
