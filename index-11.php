...
<html lang="en">
  <head>
    ...
    <title>Homepage 11 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
    ...
    <main class="main">
            ...
            <div class="swiper-container swiper-group-1">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="banner-slide-11" style="background-image:url(assets/imgs/page/homepage11/hero-1.png)">
                    <div class="banner-abs">
                      <div class="container">
                        <div class="row">
                          <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 col-12">
                            <div class="box-info-banner11">
                              <h2 class="color-brand-1 mb-30 wow animate__animated animate__fadeInUp">Bring your target users together on social media</h2>
                              <p class="color-grey-500 font-sm wow animate__animated animate__fadeIn" data-wow-delay=".2s">Duis justo nulla, pulvinar at dolor dapibus, finibus cursus massa. Praesent quam diam, faucibus tristique enim in, rhoncus aliquam lorem. Vestibulum vestibulum pellentesque nunc sit amet ullamcorper. Praesent ligula felis</p>
                              <div class="mt-30 d-flex wow animate__animated animate__fadeIn" data-wow-delay=".4s"><img class="w-50 mr-10" src="assets/imgs/template/appstore.png" alt="iori"><img class="w-50" src="assets/imgs/template/google-play.png" alt="iori"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="swiper-slide">
                  <div class="banner-slide-11" style="background-image:url(assets/imgs/page/homepage11/hero-2.png)">
                    <div class="banner-abs">
                      <div class="container">
                        <div class="row">
                          <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 col-12">
                            <div class="box-info-banner11">
                              <h2 class="color-brand-1 mb-30">Let's make something great together.</h2>
                              <p class="color-grey-500 font-sm">Duis justo nulla, pulvinar at dolor dapibus, finibus cursus massa. Praesent quam diam, faucibus tristique enim in, rhoncus aliquam lorem. Vestibulum vestibulum pellentesque nunc sit amet ullamcorper. Praesent ligula felis</p>
                              <div class="mt-30 d-flex"><img class="w-50 mr-10" src="assets/imgs/template/appstore.png" alt="iori"><img class="w-50" src="assets/imgs/template/google-play.png" alt="iori"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="swiper-slide">
                  <div class="banner-slide-11" style="background-image:url(assets/imgs/page/homepage11/hero-3.png)">
                    <div class="banner-abs">
                      <div class="container">
                        <div class="row">
                          <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 col-12">
                            <div class="box-info-banner11">
                              <h2 class="color-brand-1 mb-30">Use flexible components to build an app quickly</h2>
                              <p class="color-grey-500 font-sm">Duis justo nulla, pulvinar at dolor dapibus, finibus cursus massa. Praesent quam diam, faucibus tristique enim in, rhoncus aliquam lorem. Vestibulum vestibulum pellentesque nunc sit amet ullamcorper. Praesent ligula felis</p>
                              <div class="mt-30 d-flex"><img class="w-50 mr-10" src="assets/imgs/template/appstore.png" alt="iori"><img class="w-50" src="assets/imgs/template/google-play.png" alt="iori"></div>
                            </div>
                          </div>
                ...
                <div class="swiper-slide">
                  <div class="banner-slide-11" style="background-image:url(assets/imgs/page/homepage11/hero-5.png)">
                    <div class="banner-abs">
                      <div class="container">
                        <div class="row">
                          <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 col-12">
                            <div class="box-info-banner11">
                              <h2 class="color-brand-1 mb-30">Flex will remind you when to complete a task</h2>
                              <p class="color-grey-500 font-sm">Duis justo nulla, pulvinar at dolor dapibus, finibus cursus massa. Praesent quam diam, faucibus tristique enim in, rhoncus aliquam lorem. Vestibulum vestibulum pellentesque nunc sit amet ullamcorper. Praesent ligula felis</p>
                              <div class="mt-30 d-flex"><img class="w-50 mr-10" src="assets/imgs/template/appstore.png" alt="iori"><img class="w-50" src="assets/imgs/template/google-play.png" alt="iori"></div>
                            </div>
                          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-5 col-lg-5 mb-30">
              ...
              <h2 class="color-white mb-5">See why we are<br class="d-none d-lg-block">trusted the<br class="d-none d-lg-block">world over</h2>
            </div>
            <div class="col-xl-7 col-lg-7 mb-30">
              <p class="font-sm color-white mb-20">Et quaerat deserunt et numquam voluptatem et laborum consectetur non consequatur temporibus ea repellat nihil vel consectetur dolores et rerum voluptas. Nam voluptas reiciendis non laborum perspiciatis eum omnis cumque ab impedit earum ex quos porro sit dolorem cupiditate ut ducimus autem.</p>
              <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-6 mt-20">
                  <h2 class="color-white"><span class="count">469</span><span>k</span></h2>
                  <p class="font-lg color-white">Social followers</p>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-6 mt-20">
                  <h2 class="color-white"><span class="count">25</span><span>k+</span></h2>
                  <p class="font-lg color-white">Happy Clients</p>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-6 mt-20">
                  <h2 class="color-white"><span class="count">756</span><span>+</span></h2>
                  <p class="font-lg color-white">Project Done</p>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-6 mt-20">
                  <h2 class="color-white"><span class="count">100</span><span>+</span></h2>
                  <p class="font-lg color-white">Global branch</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                <div class="card-offer card-offer-2 hover-up">
                  ...
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-15">Business trategy</h4>
      ...
      <div class="section mt-30">
        <div class="container">
          <div class="mt-30">
            <ul class="list-partners list-partners-6">
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".1s"><img src="assets/imgs/page/homepage1/placed.png" alt="iori"></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".2s"><img src="assets/imgs/page/homepage1/cuebiq.png" alt="iori"></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".3s"><img src="assets/imgs/page/homepage1/factual.png" alt="iori"></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".4s"><img src="assets/imgs/page/homepage1/placeiq.png" alt="iori"></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".5s"><img src="assets/imgs/page/homepage1/airmeet.png" alt="iori"></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".6s"><img src="assets/imgs/page/homepage1/spen.png" alt="iori"></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="bg-brand-1 box-cover-video box-cover-video-convert bd-rd0">
            <div class="row align-items-center">
              ...
              <div class="col-xl-6 col-lg-6 pl-mb-0">
                <div class="img-reveal"><img class="d-block" src="assets/imgs/page/homepage4/img-video.png" alt="iori"></div>
              </div>
            </div>
          </div>
        </div>
